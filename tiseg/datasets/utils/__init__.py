...
from .instance_semantic import (convert_instance_to_semantic, re_instance, get_tc_from_inst, align_inst_to_sem)
...
__all__ = [
    ...
    'get_tc_from_inst', 'Drawer', 'get_dir_from_inst', 'align_inst_to_sem'
]
