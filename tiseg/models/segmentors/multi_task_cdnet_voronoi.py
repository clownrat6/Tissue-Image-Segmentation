...
from ..heads import MultiTaskCDVoronoiHead
...
class MultiTaskCDNetVoronoiSegmentor(BaseSegmentor):
    """Base class for segmentors."""

    def __init__(self, num_classes, train_cfg, test_cfg):
        super(MultiTaskCDNetVoronoiSegmentor, self).__init__()
        ...
        self.head = MultiTaskCDVoronoiHead(
